...
// empty function here to exit the threads
...
// The working function for thread pool's every threads
// And every threads will obtain new jobs from this function
// to get a exactly job and then it will finish the required the jobs
// by calling working functions
